      ...
      <div className="container">
        ...
        <div className={style.buttonblock}>
          <div className={style.buttondecor}>
            <img
              src="/Podcast/image/homepage/downloadapp/button-decor.png"
        ...
        <div className={style.social}>
          <img
            src="/Podcast/image/homepage/downloadapp/google.svg"
            className={style.socialitem}
            alt="google podcast"
          />
          <img
            src="/Podcast/image/homepage/downloadapp/spotify.svg"
            className={style.socialitem}
            alt="google podcast"
          />
          <img
            src="/Podcast/image/homepage/downloadapp/youtube.svg"
            className={style.socialitem}
            alt="google podcast"
          />
        </div>
        <div className={style.leftdecorblock}>
          <img
            src="/Podcast/image/homepage/downloadapp/phoneleft.png"
            className={style.leftdecormainimg}
            alt="мобильный телефон с открытым сайтом Podcast"
          />
          <img
            src="/Podcast/image/homepage/downloadapp/big-red-decor.png"
            className={style.leftdecorbigred}
            alt="красное солнышко"
          />
          <img
            src="/Podcast/image/homepage/downloadapp/middle-red-decor.png"
            className={style.leftdecormiddlered}
            alt="красное солнышко"
          />
          <img
            src="/Podcast/image/homepage/downloadapp/little-red-decor.png"
        ...
        <div className={style.rightdecorblock}>
          <img
            src="/Podcast/image/homepage/downloadapp/phoneright.png"
            className={style.rightdecormainimg}
            alt="мобильный телефон с открытым сайтом Podcast"
          />
          <img
            src="/Podcast/image/homepage/downloadapp/black-decor.png"
